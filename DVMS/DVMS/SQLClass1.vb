...
Public Class SQLControl
    Private DBCon As New SqlConnection With {.ConnectionString = "Data Source=imfi-lenovo-111;Initial Catalog=dbDAVMS01;Password=******;Persist Security Info=True;User ID=******"}
