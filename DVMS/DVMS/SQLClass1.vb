...
Public Class SQLControl
    Private DBCon As New SqlConnection With {.ConnectionString = "Data Source=10.50.160.92;;Initial Catalog=dbDAVMS01;Password=L5tm5insql;Persist Security Info=True;User ID=obaid1"}
